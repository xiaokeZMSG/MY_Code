...
void R_PORT_Create(void)
{
    ...
    PORT.AP1 = _PORT_APn7_OUTPUT_HIGH | _PORT_APn3_OUTPUT_LOW | _PORT_APn0_OUTPUT_LOW;
...
void R_APORT0_SetCAN1(void)
{
    ...
    /* Analog Port0 setting */
    PORT.AP0   &= ~(1u<<5);  // _PORT_APn5_OUTPUT_LOW;
    PORT.APM0  &= ~(1u<<5);
    ...
    /* Analog Port0 setting */
    PORT.AP0   |= (1u<<5);  // _PORT_APn5_OUTPUT_HIGH;
    PORT.APM0  &= ~(1u<<5);
    /* Port9 setting */
...
void R_PORT8_Set1000mA(void)
{
   ...
   // PORT.P8 = _PORT_Pn8_OUTPUT_LOW | _PORT_Pn6_OUTPUT_HIGH;   
   // PORT.PM8 = _PORT_PM8_DEFAULT_VALUE | _PORT_PMn12_MODE_UNUSED | _PORT_PMn11_MODE_UNUSED | _PORT_PMn10_MODE_UNUSED | 
   //            _PORT_PMn9_MODE_UNUSED | _PORT_PMn8_MODE_OUTPUT | _PORT_PMn7_MODE_UNUSED | _PORT_PMn6_MODE_OUTPUT | 
...
void R_PORT8_Set350mA(void)
{
 ...
 //   PORT.P8 = _PORT_Pn8_OUTPUT_HIGH | _PORT_Pn6_OUTPUT_LOW;
 //   PORT.PM8 = _PORT_PM8_DEFAULT_VALUE | _PORT_PMn12_MODE_UNUSED | _PORT_PMn11_MODE_UNUSED | _PORT_PMn10_MODE_UNUSED | 
 //             _PORT_PMn9_MODE_UNUSED | _PORT_PMn8_MODE_OUTPUT | _PORT_PMn7_MODE_UNUSED | _PORT_PMn6_MODE_OUTPUT | 
 //              _PORT_PMn5_MODE_UNUSED | _PORT_PMn4_MODE_UNUSED | _PORT_PMn3_MODE_UNUSED | _PORT_PMn2_MODE_UNUSED | 
 //             _PORT_PMn1_MODE_UNUSED | _PORT_PMn0_MODE_UNUSED;
