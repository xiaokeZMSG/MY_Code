...
void R_CGC_Create(void)
{
    ...
    /* CPU clock setting */
    WPROTR.PROTCMD1 = _WRITE_PROTECT_COMMAND;
    CLKCTL.CKSC_CPUCLKD_CTL = _CGC_CPLLOUT_DIVIDER_4 | _CGC_CPU_CLK_DIVIDER_1;    //_CGC_CPLLOUT_DIVIDER_6
    ...
    CLKCTL.CKSC_CPUCLKS_CTL = _CGC_CPU_CLK_SOURCE_CPLLOUT;
    while (CLKCTL.CKSC_CPUCLKS_ACT != _CGC_CPU_CLK_SOURCE_CPLLOUT)    //_CGC_CPU_CLK_SOURCE_EMCLK
    {
        NOP();
    }
    ...
    /* PPLLCLK setting */
    WPROTR.PROTCMD1 = _WRITE_PROTECT_COMMAND;
    CLKCTL.CKSC_PPLLCLKS_CTL = _CGC_PPLLCLK_SOURCE_PPLLOUT;   //_CGC_PPLLCLK_SOURCE_EMCLK
    ...
    CLKCTL.CKSC_ICANOSCD_CTL = _CGC_RSCANOSC_CLK_SOURCE_MAINOSC;
    while (CLKCTL.CKSC_ICANOSCD_CTL != _CGC_RSCANOSC_CLK_SOURCE_MAINOSC)
    {
        NOP();
    }
