...
/* Variables */
/*===========================================================================*/
can_frame_t CAN_RxFIFOStandData;
...

{
    ...
    if(CAN_RTN_OK != R_CAN_ReadRxBuffer(&num, &CAN_RxFIFOStandData))   //R_CAN_ReadRxFIFO
    {
        if(CAN_RxFIFOStandData.ID == 0x111 && g_SystemStatus.LED_Luminance != CAN_RxFIFOStandData.DB[0])
        {
	    g_SystemStatus.LED_Luminance = CAN_RxFIFOStandData.DB[0];
        }
        return 1;
    }
