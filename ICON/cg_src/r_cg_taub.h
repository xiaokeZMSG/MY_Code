...
Macro definitions
***********************************************************************************************************************/
#define _TAUB0_CHANNEL10_COMPARE_VALUE                      (0x9C3FU) /* Data register for compare values */
#define _TAUB0_CHANNEL12_COMPARE_VALUE                      (0x0520U) /* Data register for compare values */
#define _TAUB0_CHANNEL14_COMPARE_VALUE                      (0x0520U) /* Data register for compare values */
/* Overflow macro */
#define _TAUB_OVERFLOW_OCCURS                               (0x01U)    /* Overflow occurs */
#define _TAUB_OVERFLOW_VALUE                                (0x10000U) /* Overflow value */
...
void R_TAUB0_Channel12_first_duty(uint32_t value);
