...
;-----------------------------------------------------------------------------
	...
	.align	16
	jr32	_Dummy_EI ;_Dummy_EI ; TRAP0
	...
	.align	16
	syncp
	jr32    _INTOSTM0_interrupt ; _INTOSTM0_interrupt ;INTn(priority0)
	...
	.align	16
	syncp
	jr32	 _Dummy_EI ;_Dummy_EI ; INTn(priority7)
	...
	.align	16
	syncp
	jr32	 _Dummy_EI ;_Dummy_EI ; INTn(priority15)
...
$ifdef __RH850_F1L__	
	...
	.dw	#_INTADCA0ERR
	.offset (0x4c*4)
	.dw	#_INTOSTM0_interrupt  ;_INTOSTM0_interrupt 	
	;.dw	#_Dummy_EI ; INT0
	;.dw	#_Dummy_EI ; INT1
	;.dw	#_Dummy_EI ; INT2
	;.rept	512 - 3
...
;-----------------------------------------------------------------------------
	...
	ICBASE	.set	0xffff9000      ;0xfffeea00
	EBASE   .set    0x20000
