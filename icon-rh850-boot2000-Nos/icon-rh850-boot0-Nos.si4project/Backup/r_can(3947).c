...
#endif
#ifdef __CSP__
  #pragma interrupt CanIsrGRxFifo(enable=manual)
  void CanIsrGRxFifo(void)
#endif /* __CSP__*/
{
  can_frame_t pFrame;
  volatile uint8_t FESTS = 0;
  uint8_t MaxCount = 128;
  do
  {
	  RSCAN0.RFSTS1.UINT32 &= (~kCanSrRxFifoIntFlag); 
	  *(uint32_t*)&pFrame = RSCAN0.RFID1.UINT32;//& 0x7FFUL;
...
#endif
#ifdef __CSP__
  #pragma interrupt Can1IsrTx(enable=manual)
  void Can1IsrTx(void)
#endif /* __CSP__*/
{
