...
#include "app.h"
    ...
    #include "dr7f701587.dvf.h"//"iodefine.h"
#elif APP_COMPILER == APP_COMP_IAR
    #include "ior7f701587xafp.h"
#else
...
#define INIT_CPU_AND_FPERIPHERAL_CLK                                                            \
    ...
    CLKCTLMOSCC=0x06;                     /* Set MainOSC gain (8MHz < MOSC frequency =< 16MHz) */     \
    CLKCTLMOSCST= 0x0001FFFFUL;               /* Set MainOSC stabilization time to max (8,19 ms) */       \
                                                                                                \
