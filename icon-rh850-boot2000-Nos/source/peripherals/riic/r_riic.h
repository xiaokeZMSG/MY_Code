...
/* Function defines */
/*===========================================================================*/
//void R_IIC_Master_Transmit(int32_t fd, uint8_t slave_sddr, uint32_t len, uint32_t *transmission_data);
//void R_IIC_Master_Reception(int32_t fd, uint8_t slave_sddr, uint32_t len, uint32_t *reception_data);
...
//uint8_t R_IIC_GetState(int32_t fd);
