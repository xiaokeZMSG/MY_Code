...
#define DCM_SEC_LEV_L61			((Dcm_SecLevelType)0x61)
#define DCM_SEC_LEV_ALL			((Dcm_SecLevelType)0xFF)

/*
 * Dcm_SesCtrlType
 */
typedef uint8_t Dcm_EcuResetType;
...
typedef uint8_t Dcm_PidServiceType;
...
typedef uint8_t Dcm_PeriodicTransmitModeType;
...
typedef uint8_t Dcm_DDDSubfunctionType;
...
typedef uint8_t Dcm_PeriodicDidStartType;
