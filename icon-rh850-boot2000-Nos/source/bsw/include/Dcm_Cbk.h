...
#define ECU_CFG_FRS BIT0
#define ECU_CFG_FCS BIT1
...
void Dcm_ComM_NoComModeEntered( uint8_t NetworkId ); /** @req DCM356 */
void Dcm_ComM_SilentComModeEntered( uint8_t NetworkId ); /** @req DCM358 */
void Dcm_ComM_FullComModeEntered( uint8_t NetworkId ); /** @req DCM360 */
