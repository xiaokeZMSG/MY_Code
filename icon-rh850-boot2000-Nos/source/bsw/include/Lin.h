...
#define LIN_VENDOR_ID            60

#define LIN_SW_MAJOR_VERSION            2
#define LIN_SW_MINOR_VERSION   	        1
#define LIN_SW_PATCH_VERSION            0
#define LIN_AR_RELEASE_MAJOR_VERSION    4
#define LIN_AR_RELEASE_MINOR_VERSION    1
#define LIN_AR_RELEASE_PATCH_VERSION    2
...
#define LIN_WAKE_UP_INTERNAL_SERVICE_ID   0x0B
//@}
