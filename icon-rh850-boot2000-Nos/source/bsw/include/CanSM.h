...
#define CANSM_SW_MAJOR_VERSION	2
...
#define CANSM_E_INVALID_ACTION          0x11
#define CANSM_E_UNEXPECTED_EXECUTION    0x12
#define CANSM_E_INVALID_INVALID_BUSOFF  0x13
...
#if (CANSM_CAN_TRCV_SUPPORT == STD_ON)
#define CANSM_SERVICEID_TRANSCEIVERMODEINDICATION   0x09
#endif
