...
/* Standard info */
#define EEP_VENDOR_ID             (60)
#define EEP_MODULE_ID			  (21)
#define EEP_SW_MAJOR_VERSION      2
#define EEP_SW_MINOR_VERSION      0
#define EEP_SW_PATCH_VERSION      0
#define EEP_AR_RELASE_MAJOR_VERSION      4
#define EEP_AR_RELASE_MINOR_VERSION      1
#define EEP_AR_RELASE_PATCH_VERSION      2
