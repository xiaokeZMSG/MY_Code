...
/** @req NM035 */
Std_ReturnType Nm_SetUserData( const NetworkHandleType NetworkHandle, const uint8_t * const nmUserDataPtr );
...
/** @req NM036 */
Std_ReturnType Nm_GetUserData( const NetworkHandleType NetworkHandle, uint8_t * const nmUserDataPtr );

/** Get the whole PDU data out of the most recently received NM message.
  * For that purpose CanNm_GetPduData shall be called. */
/** @req NM037 */
Std_ReturnType Nm_GetPduData( const NetworkHandleType NetworkHandle, uint8_t * const nmPduData );
...
/** @req NM039 */
Std_ReturnType Nm_GetNodeIdentifier( const NetworkHandleType NetworkHandle, uint8_t * const nmNodeIdPtr );
...
/** @req NM040 */
Std_ReturnType Nm_GetLocalNodeIdentifier( const NetworkHandleType NetworkHandle, uint8_t * const nmNodeIdPtr );
