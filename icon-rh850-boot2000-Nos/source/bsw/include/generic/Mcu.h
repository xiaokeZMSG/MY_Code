...
/* @req SWS_Mcu_00053 Assigned by DEM */
#if defined(USE_DEM)
#include "Dem.h"
#endif
...
typedef struct {
    ...
    uint8_t Pll1; // PLL setting 1
    uint8_t Pll2; // PLL setting 2
    uint8_t Pll3; // PLL setting 3
    uint8_t Pll1_1; // PLL setting 1
    uint8_t Pll2_1; // PLL setting 2
    uint8_t Pll3_1; // PLL setting 3
    uint8_t Pll4; // PLL setting 4
