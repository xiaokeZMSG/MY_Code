...
void Dcm_TpRxIndication(PduIdType dcmRxPduId, NotifResultType result)
{
   ...
   // PwrM_CanTp_CallOut(30000);
	DslTpRxIndicationFromPduR(dcmRxPduId, result, FALSE);
}
...
{
    return (DspTesterRequestDTC(ecu_id,subfunc,pDTC,mask));
}
