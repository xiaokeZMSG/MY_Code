...
static void changeDiagnosticSession(Dcm_DslRunTimeProtocolParametersType *runtime, Dcm_SesCtrlType newSession) {
	...
	Communication_Control_TX_Disabled = 0;//added 20210728,enable communication when session timeout,change to default session
	Communication_Control_RX_Disabled = 0;
	Dem_EnableDTCSetting(DEM_DTC_GROUP_ALL_DTCS, DEM_DTC_KIND_ALL_DTCS);//added 20210728,enable DTC setting 
...
void extern_releaseExternalRxTxBuffers(void)
{
    const Dcm_DslProtocolRowType         *protocolRowEntry;
    Dcm_DslRunTimeProtocolParametersType *runtime = NULL;
