...
/* Start user code for global. Do not edit comment generated here */
 ...
 uint8_t     recv_data[ 1U];
 
 #define     MAX_9291_ADDR     (0x40)   // 80
 #define     MAX_9278_ADDR     (0x48)   // 90


/* MAX9291 REGISTER */     
#define   HDMI_MHL_DEVICE                   (0x78)    // 0xF0

#define   HPD_C_CTRL                        (0xE9)
#define   HPD_OEN_CTRL                      (0xEA)

#define   HDMI_AON_DEVICE                   (0x60) >> 1  // 0X62
...
void test_max9291(void)
{
    ...
    num = 1;
    R_RIIC0_Master_Send(HDMI_AON_DEVICE,(uint8_t*)&send_data[0] , num);
    delay(100);

    R_RIIC0_Master_Receive(HDMI_AON_DEVICE, (uint8_t*)&recv_data[0], sizeof(recv_data));
    delay(100);
